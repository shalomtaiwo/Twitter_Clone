...
var eventListeners = /** @class */ (function (_super) {
    ...
    eventListeners.prototype.submitEvent = function () {
        ...
        document.addEventListener("submit", function (e) {
            e.preventDefault();
            while (!_this.tweetImage.value && _this.viewportWidth <= 500) {
